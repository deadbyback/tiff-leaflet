...
L.LeafletGeotiff = L.ImageOverlay.extend({
    ...
    _getData: function(url) {
        ...
        request.onload = function() {
            if (this.status >= 200 && this.status < 400) {
                ...
                throw new Error("GeoTIFF are not defined!");
            }
        };
    ...
    _parseTIFF: function(arrayBuffer) {
        ...
        if (!this.options.bounds) {
            ...
            if (typeof(meta.ModelTiepoint[3]) != "undefined" && meta.ModelTiepoint[3] !== null) {
            ...
            } else if (typeof(meta.ModelTransformation[0]) != "undefined" && meta.ModelTransformation[0] !== null) {
                ...
                throw new Error("GeoParams are not defined!");
            }
